...
public final class TrafficIntersectionRegistry {
	...
	public static boolean applyDashboardUpdate(String intersectionId, String action, int delta, String value) {
		...
		final Optional<TrafficIntersectionDefinition> updatedDefinition = TrafficIntersectionEditor.update(definition, action, delta, value);
		if (updatedDefinition.isEmpty()) {
			return false;
		}
		final TrafficIntersectionDefinition updated = updatedDefinition.get();
