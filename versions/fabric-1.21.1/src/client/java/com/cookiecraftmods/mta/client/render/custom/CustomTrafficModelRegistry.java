...
public final class CustomTrafficModelRegistry implements SimpleSynchronousResourceReloadListener {
	...
	private static final ResourceLocation RELOAD_LISTENER_ID = ResourceLocation.fromNamespaceAndPath(MTRTrafficAddon.MOD_ID, "custom_traffic_models");
	private static final String MODEL_DEFINITION_DIRECTORY = "traffic_models";
	private static final ResourceLocation DEFAULT_TEXTURE = ResourceLocation.fromNamespaceAndPath("minecraft", "textures/block/white_concrete.png");
	...
	private static ResourceLocation resourceLocationValue(JsonObject object, String key, ResourceLocation defaultValue) {
		...
		return rawValue.isBlank() ? defaultValue : ResourceLocation.parse(rawValue);
	}
}
