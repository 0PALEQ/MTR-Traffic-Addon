...
final class ObjTrafficModelLoader {
	...
	private static ResourceLocation resolveMaterialTexture(ResourceLocation materialLocation, ResourceLocation defaultTexture, String rawPath) {
		if (rawPath.contains(":")) {
			return ResourceLocation.parse(rawPath);
		}
		if (defaultTexture != null) {
			...
			return ResourceLocation.fromNamespaceAndPath(defaultTexture.getNamespace(), textureDirectory + normalizeRelativePath(rawPath));
		}
	...
	private static ResourceLocation resolveSibling(ResourceLocation sourceLocation, String rawPath) {
		...
		return ResourceLocation.fromNamespaceAndPath(sourceLocation.getNamespace(), directory + normalizeRelativePath(rawPath));
	}
