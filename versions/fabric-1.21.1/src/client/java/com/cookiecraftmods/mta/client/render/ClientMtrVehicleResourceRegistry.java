...
public final class ClientMtrVehicleResourceRegistry implements SimpleSynchronousResourceReloadListener {
	...
	private static final ResourceLocation RELOAD_LISTENER_ID = ResourceLocation.fromNamespaceAndPath(MTRTrafficAddon.MOD_ID, "client_mtr_vehicle_resources");
	private static final ResourceLocation CUSTOM_RESOURCES_ID = ResourceLocation.fromNamespaceAndPath("mtr", "mtr_custom_resources.json");
	private static final ResourceLocation CUSTOM_RESOURCES_PENDING_MIGRATION_ID = ResourceLocation.fromNamespaceAndPath("mtr", "mtr_custom_resources_pending_migration.json");
